(* OASIS_START *)
(* DO NOT EDIT (digest: c16d39629ae402d529ccac17fb277df8) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/janestreet/pa_bin_prot";
          synopsis = "Syntax extension for bin_prot";
          description = None;
          categories = [];
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "|\156\255\220d\129^\251*;W\002m\212\181~";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
